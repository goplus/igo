...
func execMultiReader(arity int, p *igo.Context) {
...
func execMultiWriter(arity int, p *igo.Context) {
	args := p.GetArgs(arity)
...
func execNewSectionReader(_ int, p *igo.Context) {
	args := p.GetArgs(3)
...
func execmPipeReaderRead(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0, ret1 := args[0].(*io.PipeReader).Read(args[1].([]byte))
	p.Ret(2, ret0, ret1)
}

func execmPipeReaderClose(_ int, p *igo.Context) {
	args := p.GetArgs(1)
