...
func execmBuilderString(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(*strings.Builder).String()
	p.Ret(1, ret0)
}

func execmBuilderLen(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(*strings.Builder).Len()
	p.Ret(1, ret0)
}

func execmBuilderCap(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(*strings.Builder).Cap()
	p.Ret(1, ret0)
}

func execmBuilderReset(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	args[0].(*strings.Builder).Reset()
	p.PopN(1)
}

func execmBuilderGrow(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	args[0].(*strings.Builder).Grow(args[1].(int))
	p.PopN(2)
}

func execmBuilderWrite(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0, ret1 := args[0].(*strings.Builder).Write(args[1].([]byte))
	p.Ret(2, ret0, ret1)
}

func execmBuilderWriteByte(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := args[0].(*strings.Builder).WriteByte(args[1].(byte))
	p.Ret(2, ret0)
}

func execmBuilderWriteRune(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0, ret1 := args[0].(*strings.Builder).WriteRune(args[1].(rune))
	p.Ret(2, ret0, ret1)
}

func execmBuilderWriteString(_ int, p *igo.Context) {
	args := p.GetArgs(2)
...
func execNewReplacer(arity int, p *igo.Context) {
	args := p.GetArgs(arity)
	ret0 := strings.NewReplacer(igo.ToStrings(args)...)
	p.Ret(arity, ret0)
}
...
func execmReplacerReplace(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := args[0].(*strings.Replacer).Replace(args[1].(string))
	p.Ret(2, ret0)
}

func execmReplacerWriteString(_ int, p *igo.Context) {
	args := p.GetArgs(3)
...
var I = igo.NewGoPackage("strings")
