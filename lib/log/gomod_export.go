...
func execFatal(arity int, p *igo.Context) {
	args := p.GetArgs(arity)
	log.Fatal(args...)
	p.PopN(arity)
}

func execFatalf(arity int, p *igo.Context) {
	args := p.GetArgs(arity)
	log.Fatalf(args[0].(string), args[1:]...)
	p.PopN(arity)
}

func execFatalln(arity int, p *igo.Context) {
	args := p.GetArgs(arity)
	log.Fatalln(args...)
	p.PopN(arity)
}

func execFlags(_ int, p *igo.Context) {
	ret0 := log.Flags()
	p.Ret(0, ret0)
}
...
func execmLoggerSetOutput(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	args[0].(*log.Logger).SetOutput(toType0(args[1]))
	p.PopN(2)
}

func execmLoggerOutput(_ int, p *igo.Context) {
	args := p.GetArgs(3)
	ret0 := args[0].(*log.Logger).Output(args[1].(int), args[2].(string))
	p.Ret(3, ret0)
}

func execmLoggerPrintf(arity int, p *igo.Context) {
	args := p.GetArgs(arity)
	args[0].(*log.Logger).Printf(args[1].(string), args[2:]...)
	p.PopN(arity)
}

func execmLoggerPrint(arity int, p *igo.Context) {
	args := p.GetArgs(arity)
	args[0].(*log.Logger).Print(args[1:]...)
	p.PopN(arity)
}

func execmLoggerPrintln(arity int, p *igo.Context) {
	args := p.GetArgs(arity)
	args[0].(*log.Logger).Println(args[1:]...)
	p.PopN(arity)
}

func execmLoggerFatal(arity int, p *igo.Context) {
	args := p.GetArgs(arity)
	args[0].(*log.Logger).Fatal(args[1:]...)
	p.PopN(arity)
}

func execmLoggerFatalf(arity int, p *igo.Context) {
	args := p.GetArgs(arity)
	args[0].(*log.Logger).Fatalf(args[1].(string), args[2:]...)
	p.PopN(arity)
}

func execmLoggerFatalln(arity int, p *igo.Context) {
	args := p.GetArgs(arity)
	args[0].(*log.Logger).Fatalln(args[1:]...)
	p.PopN(arity)
}

func execmLoggerPanic(arity int, p *igo.Context) {
	args := p.GetArgs(arity)
	args[0].(*log.Logger).Panic(args[1:]...)
	p.PopN(arity)
}

func execmLoggerPanicf(arity int, p *igo.Context) {
	args := p.GetArgs(arity)
	args[0].(*log.Logger).Panicf(args[1].(string), args[2:]...)
	p.PopN(arity)
}

func execmLoggerPanicln(arity int, p *igo.Context) {
	args := p.GetArgs(arity)
	args[0].(*log.Logger).Panicln(args[1:]...)
	p.PopN(arity)
}

func execmLoggerFlags(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(*log.Logger).Flags()
	p.Ret(1, ret0)
}

func execmLoggerSetFlags(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	args[0].(*log.Logger).SetFlags(args[1].(int))
	p.PopN(2)
}

func execmLoggerPrefix(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(*log.Logger).Prefix()
	p.Ret(1, ret0)
}

func execmLoggerSetPrefix(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	args[0].(*log.Logger).SetPrefix(args[1].(string))
	p.PopN(2)
}

func execmLoggerWriter(_ int, p *igo.Context) {
	args := p.GetArgs(1)
...
func execOutput(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := log.Output(args[0].(int), args[1].(string))
	p.Ret(2, ret0)
}

func execPanic(arity int, p *igo.Context) {
	args := p.GetArgs(arity)
	log.Panic(args...)
	p.PopN(arity)
}

func execPanicf(arity int, p *igo.Context) {
	args := p.GetArgs(arity)
	log.Panicf(args[0].(string), args[1:]...)
	p.PopN(arity)
}

func execPanicln(arity int, p *igo.Context) {
	args := p.GetArgs(arity)
	log.Panicln(args...)
	p.PopN(arity)
}

func execPrefix(_ int, p *igo.Context) {
	ret0 := log.Prefix()
	p.Ret(0, ret0)
}

func execPrint(arity int, p *igo.Context) {
	args := p.GetArgs(arity)
	log.Print(args...)
	p.PopN(arity)
}

func execPrintf(arity int, p *igo.Context) {
	args := p.GetArgs(arity)
	log.Printf(args[0].(string), args[1:]...)
	p.PopN(arity)
}

func execPrintln(arity int, p *igo.Context) {
	args := p.GetArgs(arity)
	log.Println(args...)
	p.PopN(arity)
}

func execSetFlags(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	log.SetFlags(args[0].(int))
	p.PopN(1)
}

func execSetOutput(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	log.SetOutput(toType0(args[0]))
	p.PopN(1)
}

func execSetPrefix(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	log.SetPrefix(args[0].(string))
	p.PopN(1)
}

func execWriter(_ int, p *igo.Context) {
	ret0 := log.Writer()
	p.Ret(0, ret0)
}

// I is a Go package instance.
var I = igo.NewGoPackage("log")
