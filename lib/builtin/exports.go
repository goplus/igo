...
func execPanic(_ int, p *igo.Context) {
	panic(p.Pop())
}
...
var builtinFnvs = map[string][2]string{
	...
	"println":      {"fmt", "Println"},
	"fprintf":      {"fmt", "Fprintf"},
	"_gop_NewIter": {"github.com/goplus/igo/ast/gopiter", "NewIter"},
	"_gop_Next":    {"github.com/goplus/igo/ast/gopiter", "Next"},
	"_gop_Key":     {"github.com/goplus/igo/ast/gopiter", "Key"},
	"_gop_Value":   {"github.com/goplus/igo/ast/gopiter", "Value"},
}
