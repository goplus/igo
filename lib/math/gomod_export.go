...
func execAbs(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Abs(args[0].(float64))
	p.Ret(1, ret0)
}

func execAcos(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Acos(args[0].(float64))
	p.Ret(1, ret0)
}

func execAcosh(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Acosh(args[0].(float64))
	p.Ret(1, ret0)
}

func execAsin(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Asin(args[0].(float64))
	p.Ret(1, ret0)
}

func execAsinh(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Asinh(args[0].(float64))
	p.Ret(1, ret0)
}

func execAtan(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Atan(args[0].(float64))
	p.Ret(1, ret0)
}

func execAtan2(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := math.Atan2(args[0].(float64), args[1].(float64))
	p.Ret(2, ret0)
}

func execAtanh(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Atanh(args[0].(float64))
	p.Ret(1, ret0)
}

func execCbrt(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Cbrt(args[0].(float64))
	p.Ret(1, ret0)
}

func execCeil(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Ceil(args[0].(float64))
	p.Ret(1, ret0)
}

func execCopysign(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := math.Copysign(args[0].(float64), args[1].(float64))
	p.Ret(2, ret0)
}

func execCos(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Cos(args[0].(float64))
	p.Ret(1, ret0)
}

func execCosh(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Cosh(args[0].(float64))
	p.Ret(1, ret0)
}

func execDim(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := math.Dim(args[0].(float64), args[1].(float64))
	p.Ret(2, ret0)
}

func execErf(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Erf(args[0].(float64))
	p.Ret(1, ret0)
}

func execErfc(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Erfc(args[0].(float64))
	p.Ret(1, ret0)
}

func execErfcinv(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Erfcinv(args[0].(float64))
	p.Ret(1, ret0)
}

func execErfinv(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Erfinv(args[0].(float64))
	p.Ret(1, ret0)
}

func execExp(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Exp(args[0].(float64))
	p.Ret(1, ret0)
}

func execExp2(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Exp2(args[0].(float64))
	p.Ret(1, ret0)
}

func execExpm1(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Expm1(args[0].(float64))
	p.Ret(1, ret0)
}

func execFMA(_ int, p *igo.Context) {
	args := p.GetArgs(3)
	ret0 := math.FMA(args[0].(float64), args[1].(float64), args[2].(float64))
	p.Ret(3, ret0)
}

func execFloat32bits(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Float32bits(args[0].(float32))
	p.Ret(1, ret0)
}

func execFloat32frombits(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Float32frombits(args[0].(uint32))
	p.Ret(1, ret0)
}

func execFloat64bits(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Float64bits(args[0].(float64))
	p.Ret(1, ret0)
}

func execFloat64frombits(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Float64frombits(args[0].(uint64))
	p.Ret(1, ret0)
}

func execFloor(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Floor(args[0].(float64))
	p.Ret(1, ret0)
}

func execFrexp(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0, ret1 := math.Frexp(args[0].(float64))
	p.Ret(1, ret0, ret1)
}

func execGamma(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Gamma(args[0].(float64))
	p.Ret(1, ret0)
}

func execHypot(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := math.Hypot(args[0].(float64), args[1].(float64))
	p.Ret(2, ret0)
}

func execIlogb(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Ilogb(args[0].(float64))
	p.Ret(1, ret0)
}

func execInf(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Inf(args[0].(int))
	p.Ret(1, ret0)
}

func execIsInf(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := math.IsInf(args[0].(float64), args[1].(int))
	p.Ret(2, ret0)
}

func execIsNaN(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.IsNaN(args[0].(float64))
	p.Ret(1, ret0)
}

func execJ0(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.J0(args[0].(float64))
	p.Ret(1, ret0)
}

func execJ1(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.J1(args[0].(float64))
	p.Ret(1, ret0)
}

func execJn(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := math.Jn(args[0].(int), args[1].(float64))
	p.Ret(2, ret0)
}

func execLdexp(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := math.Ldexp(args[0].(float64), args[1].(int))
	p.Ret(2, ret0)
}

func execLgamma(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0, ret1 := math.Lgamma(args[0].(float64))
	p.Ret(1, ret0, ret1)
}

func execLog(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Log(args[0].(float64))
	p.Ret(1, ret0)
}

func execLog10(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Log10(args[0].(float64))
	p.Ret(1, ret0)
}

func execLog1p(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Log1p(args[0].(float64))
	p.Ret(1, ret0)
}

func execLog2(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Log2(args[0].(float64))
	p.Ret(1, ret0)
}

func execLogb(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Logb(args[0].(float64))
	p.Ret(1, ret0)
}

func execMax(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := math.Max(args[0].(float64), args[1].(float64))
	p.Ret(2, ret0)
}

func execMin(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := math.Min(args[0].(float64), args[1].(float64))
	p.Ret(2, ret0)
}

func execMod(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := math.Mod(args[0].(float64), args[1].(float64))
	p.Ret(2, ret0)
}

func execModf(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0, ret1 := math.Modf(args[0].(float64))
	p.Ret(1, ret0, ret1)
}

func execNaN(_ int, p *igo.Context) {
	ret0 := math.NaN()
	p.Ret(0, ret0)
}

func execNextafter(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := math.Nextafter(args[0].(float64), args[1].(float64))
	p.Ret(2, ret0)
}

func execNextafter32(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := math.Nextafter32(args[0].(float32), args[1].(float32))
	p.Ret(2, ret0)
}

func execPow(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := math.Pow(args[0].(float64), args[1].(float64))
	p.Ret(2, ret0)
}

func execPow10(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Pow10(args[0].(int))
	p.Ret(1, ret0)
}

func execRemainder(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := math.Remainder(args[0].(float64), args[1].(float64))
	p.Ret(2, ret0)
}

func execRound(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Round(args[0].(float64))
	p.Ret(1, ret0)
}

func execRoundToEven(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.RoundToEven(args[0].(float64))
	p.Ret(1, ret0)
}

func execSignbit(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Signbit(args[0].(float64))
	p.Ret(1, ret0)
}

func execSin(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Sin(args[0].(float64))
	p.Ret(1, ret0)
}

func execSincos(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0, ret1 := math.Sincos(args[0].(float64))
	p.Ret(1, ret0, ret1)
}

func execSinh(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Sinh(args[0].(float64))
	p.Ret(1, ret0)
}

func execSqrt(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Sqrt(args[0].(float64))
	p.Ret(1, ret0)
}

func execTan(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Tan(args[0].(float64))
	p.Ret(1, ret0)
}

func execTanh(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Tanh(args[0].(float64))
	p.Ret(1, ret0)
}

func execTrunc(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Trunc(args[0].(float64))
	p.Ret(1, ret0)
}

func execY0(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Y0(args[0].(float64))
	p.Ret(1, ret0)
}

func execY1(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := math.Y1(args[0].(float64))
	p.Ret(1, ret0)
}

func execYn(_ int, p *igo.Context) {
	args := p.GetArgs(2)
...
func init() {
	...
	I.RegisterConsts(
		...
		I.Const("MaxInt", qspec.Uint64, uint64(math.MaxInt)),
		...
		I.Const("MaxUint", qspec.Uint64, uint64(math.MaxUint)),
		...
		I.Const("MinInt", qspec.Int64, int64(math.MinInt)),
