...
func execErrorf(arity int, p *igo.Context) {
...
func execFprint(arity int, p *igo.Context) {
	args := p.GetArgs(arity)
	ret0, ret1 := fmt.Fprint(toType0(args[0]), args[1:]...)
	p.Ret(arity, ret0, ret1)
}

func execFprintf(arity int, p *igo.Context) {
	args := p.GetArgs(arity)
	ret0, ret1 := fmt.Fprintf(toType0(args[0]), args[1].(string), args[2:]...)
	p.Ret(arity, ret0, ret1)
}

func execFprintln(arity int, p *igo.Context) {
	args := p.GetArgs(arity)
...
func execFscan(arity int, p *igo.Context) {
	args := p.GetArgs(arity)
	ret0, ret1 := fmt.Fscan(toType1(args[0]), args[1:]...)
	p.Ret(arity, ret0, ret1)
}

func execFscanf(arity int, p *igo.Context) {
	args := p.GetArgs(arity)
	ret0, ret1 := fmt.Fscanf(toType1(args[0]), args[1].(string), args[2:]...)
	p.Ret(arity, ret0, ret1)
}

func execFscanln(arity int, p *igo.Context) {
	args := p.GetArgs(arity)
...
func execScan(arity int, p *igo.Context) {
	args := p.GetArgs(arity)
	ret0, ret1 := fmt.Scan(args...)
	p.Ret(arity, ret0, ret1)
}

func execScanf(arity int, p *igo.Context) {
	args := p.GetArgs(arity)
	ret0, ret1 := fmt.Scanf(args[0].(string), args[1:]...)
	p.Ret(arity, ret0, ret1)
}

func execScanln(arity int, p *igo.Context) {
	args := p.GetArgs(arity)
	ret0, ret1 := fmt.Scanln(args...)
	p.Ret(arity, ret0, ret1)
}

func execSprint(arity int, p *igo.Context) {
	args := p.GetArgs(arity)
	ret0 := fmt.Sprint(args...)
	p.Ret(arity, ret0)
}

func execSprintf(arity int, p *igo.Context) {
	args := p.GetArgs(arity)
	ret0 := fmt.Sprintf(args[0].(string), args[1:]...)
	p.Ret(arity, ret0)
}

func execSprintln(arity int, p *igo.Context) {
	args := p.GetArgs(arity)
	ret0 := fmt.Sprintln(args...)
	p.Ret(arity, ret0)
}

func execSscan(arity int, p *igo.Context) {
	args := p.GetArgs(arity)
	ret0, ret1 := fmt.Sscan(args[0].(string), args[1:]...)
	p.Ret(arity, ret0, ret1)
}

func execSscanf(arity int, p *igo.Context) {
	args := p.GetArgs(arity)
	ret0, ret1 := fmt.Sscanf(args[0].(string), args[1].(string), args[2:]...)
	p.Ret(arity, ret0, ret1)
}

func execSscanln(arity int, p *igo.Context) {
	args := p.GetArgs(arity)
