...
func execAppend(arity int, p *igo.Context) {
	args := p.GetArgs(arity)
	ret0 := reflect.Append(args[0].(reflect.Value), toSlice0(args[1:])...)
	p.Ret(arity, ret0)
}

func execAppendSlice(_ int, p *igo.Context) {
	args := p.GetArgs(2)
...
var I = igo.NewGoPackage("reflect")
