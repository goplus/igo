...
func execmBufferBytes(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(*bytes.Buffer).Bytes()
	p.Ret(1, ret0)
}

func execmBufferString(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(*bytes.Buffer).String()
	p.Ret(1, ret0)
}

func execmBufferLen(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(*bytes.Buffer).Len()
	p.Ret(1, ret0)
}

func execmBufferCap(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(*bytes.Buffer).Cap()
	p.Ret(1, ret0)
}

func execmBufferTruncate(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	args[0].(*bytes.Buffer).Truncate(args[1].(int))
	p.PopN(2)
}

func execmBufferReset(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	args[0].(*bytes.Buffer).Reset()
	p.PopN(1)
}

func execmBufferGrow(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	args[0].(*bytes.Buffer).Grow(args[1].(int))
	p.PopN(2)
}

func execmBufferWrite(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0, ret1 := args[0].(*bytes.Buffer).Write(args[1].([]byte))
	p.Ret(2, ret0, ret1)
}

func execmBufferWriteString(_ int, p *igo.Context) {
	args := p.GetArgs(2)
...
func execmBufferReadFrom(_ int, p *igo.Context) {
	args := p.GetArgs(2)
