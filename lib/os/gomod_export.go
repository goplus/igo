...
import (
	...
	qspec "github.com/goplus/igo/exec.spec"
)

func execChdir(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := os.Chdir(args[0].(string))
	p.Ret(1, ret0)
}

func execChmod(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := os.Chmod(args[0].(string), args[1].(os.FileMode))
	p.Ret(2, ret0)
}

func execChown(_ int, p *igo.Context) {
	args := p.GetArgs(3)
	ret0 := os.Chown(args[0].(string), args[1].(int), args[2].(int))
	p.Ret(3, ret0)
}

func execChtimes(_ int, p *igo.Context) {
	args := p.GetArgs(3)
	ret0 := os.Chtimes(args[0].(string), args[1].(time.Time), args[2].(time.Time))
	p.Ret(3, ret0)
}

func execClearenv(_ int, p *igo.Context) {
	os.Clearenv()
	p.PopN(0)
}

func execCreate(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0, ret1 := os.Create(args[0].(string))
	p.Ret(1, ret0, ret1)
}

func execEnviron(_ int, p *igo.Context) {
	ret0 := os.Environ()
	p.Ret(0, ret0)
}

func execExecutable(_ int, p *igo.Context) {
	ret0, ret1 := os.Executable()
	p.Ret(0, ret0, ret1)
}

func execExit(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	os.Exit(args[0].(int))
	p.PopN(1)
}

func execExpand(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := os.Expand(args[0].(string), args[1].(func(string) string))
	p.Ret(2, ret0)
}

func execExpandEnv(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := os.ExpandEnv(args[0].(string))
	p.Ret(1, ret0)
}

func execmFileReaddir(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0, ret1 := args[0].(*os.File).Readdir(args[1].(int))
	p.Ret(2, ret0, ret1)
}

func execmFileReaddirnames(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0, ret1 := args[0].(*os.File).Readdirnames(args[1].(int))
	p.Ret(2, ret0, ret1)
}

func execmFileName(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(*os.File).Name()
	p.Ret(1, ret0)
}

func execmFileRead(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0, ret1 := args[0].(*os.File).Read(args[1].([]byte))
	p.Ret(2, ret0, ret1)
}

func execmFileReadAt(_ int, p *igo.Context) {
	args := p.GetArgs(3)
	ret0, ret1 := args[0].(*os.File).ReadAt(args[1].([]byte), args[2].(int64))
	p.Ret(3, ret0, ret1)
}

func execmFileWrite(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0, ret1 := args[0].(*os.File).Write(args[1].([]byte))
	p.Ret(2, ret0, ret1)
}

func execmFileWriteAt(_ int, p *igo.Context) {
	args := p.GetArgs(3)
	ret0, ret1 := args[0].(*os.File).WriteAt(args[1].([]byte), args[2].(int64))
	p.Ret(3, ret0, ret1)
}

func execmFileSeek(_ int, p *igo.Context) {
	args := p.GetArgs(3)
	ret0, ret1 := args[0].(*os.File).Seek(args[1].(int64), args[2].(int))
	p.Ret(3, ret0, ret1)
}

func execmFileWriteString(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0, ret1 := args[0].(*os.File).WriteString(args[1].(string))
	p.Ret(2, ret0, ret1)
}

func execmFileChmod(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := args[0].(*os.File).Chmod(args[1].(os.FileMode))
	p.Ret(2, ret0)
}

func execmFileSetDeadline(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := args[0].(*os.File).SetDeadline(args[1].(time.Time))
	p.Ret(2, ret0)
}

func execmFileSetReadDeadline(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := args[0].(*os.File).SetReadDeadline(args[1].(time.Time))
	p.Ret(2, ret0)
}

func execmFileSetWriteDeadline(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := args[0].(*os.File).SetWriteDeadline(args[1].(time.Time))
	p.Ret(2, ret0)
}

func execmFileSyscallConn(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0, ret1 := args[0].(*os.File).SyscallConn()
	p.Ret(1, ret0, ret1)
}

func execmFileChown(_ int, p *igo.Context) {
	args := p.GetArgs(3)
	ret0 := args[0].(*os.File).Chown(args[1].(int), args[2].(int))
	p.Ret(3, ret0)
}

func execmFileTruncate(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := args[0].(*os.File).Truncate(args[1].(int64))
	p.Ret(2, ret0)
}

func execmFileSync(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(*os.File).Sync()
	p.Ret(1, ret0)
}

func execmFileChdir(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(*os.File).Chdir()
	p.Ret(1, ret0)
}

func execmFileFd(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(*os.File).Fd()
	p.Ret(1, ret0)
}

func execmFileClose(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(*os.File).Close()
	p.Ret(1, ret0)
}

func execmFileStat(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0, ret1 := args[0].(*os.File).Stat()
	p.Ret(1, ret0, ret1)
}

func execmFileModeString(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(os.FileMode).String()
	p.Ret(1, ret0)
}

func execmFileModeIsDir(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(os.FileMode).IsDir()
	p.Ret(1, ret0)
}

func execmFileModeIsRegular(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(os.FileMode).IsRegular()
	p.Ret(1, ret0)
}

func execmFileModePerm(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(os.FileMode).Perm()
	p.Ret(1, ret0)
}

func execFindProcess(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0, ret1 := os.FindProcess(args[0].(int))
	p.Ret(1, ret0, ret1)
}

func execGetegid(_ int, p *igo.Context) {
	ret0 := os.Getegid()
	p.Ret(0, ret0)
}

func execGetenv(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := os.Getenv(args[0].(string))
	p.Ret(1, ret0)
}

func execGeteuid(_ int, p *igo.Context) {
	ret0 := os.Geteuid()
	p.Ret(0, ret0)
}

func execGetgid(_ int, p *igo.Context) {
	ret0 := os.Getgid()
	p.Ret(0, ret0)
}

func execGetgroups(_ int, p *igo.Context) {
	ret0, ret1 := os.Getgroups()
	p.Ret(0, ret0, ret1)
}

func execGetpagesize(_ int, p *igo.Context) {
	ret0 := os.Getpagesize()
	p.Ret(0, ret0)
}

func execGetpid(_ int, p *igo.Context) {
	ret0 := os.Getpid()
	p.Ret(0, ret0)
}

func execGetppid(_ int, p *igo.Context) {
	ret0 := os.Getppid()
	p.Ret(0, ret0)
}

func execGetuid(_ int, p *igo.Context) {
	ret0 := os.Getuid()
	p.Ret(0, ret0)
}

func execGetwd(_ int, p *igo.Context) {
	ret0, ret1 := os.Getwd()
	p.Ret(0, ret0, ret1)
}

func execHostname(_ int, p *igo.Context) {
...
func execIsExist(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := os.IsExist(toType0(args[0]))
	p.Ret(1, ret0)
}

func execIsNotExist(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := os.IsNotExist(toType0(args[0]))
	p.Ret(1, ret0)
}

func execIsPathSeparator(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := os.IsPathSeparator(args[0].(uint8))
	p.Ret(1, ret0)
}

func execIsPermission(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := os.IsPermission(toType0(args[0]))
	p.Ret(1, ret0)
}

func execIsTimeout(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := os.IsTimeout(toType0(args[0]))
	p.Ret(1, ret0)
}

func execLchown(_ int, p *igo.Context) {
	args := p.GetArgs(3)
	ret0 := os.Lchown(args[0].(string), args[1].(int), args[2].(int))
	p.Ret(3, ret0)
}

func execLink(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := os.Link(args[0].(string), args[1].(string))
	p.Ret(2, ret0)
}

func execmLinkErrorError(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(*os.LinkError).Error()
	p.Ret(1, ret0)
}

func execmLinkErrorUnwrap(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(*os.LinkError).Unwrap()
	p.Ret(1, ret0)
}

func execLookupEnv(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0, ret1 := os.LookupEnv(args[0].(string))
	p.Ret(1, ret0, ret1)
}

func execLstat(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0, ret1 := os.Lstat(args[0].(string))
	p.Ret(1, ret0, ret1)
}

func execMkdir(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := os.Mkdir(args[0].(string), args[1].(os.FileMode))
	p.Ret(2, ret0)
}

func execMkdirAll(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := os.MkdirAll(args[0].(string), args[1].(os.FileMode))
	p.Ret(2, ret0)
}

func execNewFile(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := os.NewFile(args[0].(uintptr), args[1].(string))
	p.Ret(2, ret0)
}

func execNewSyscallError(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := os.NewSyscallError(args[0].(string), toType0(args[1]))
	p.Ret(2, ret0)
}

func execOpen(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0, ret1 := os.Open(args[0].(string))
	p.Ret(1, ret0, ret1)
}

func execOpenFile(_ int, p *igo.Context) {
	args := p.GetArgs(3)
	ret0, ret1 := os.OpenFile(args[0].(string), args[1].(int), args[2].(os.FileMode))
	p.Ret(3, ret0, ret1)
}

func execmPathErrorError(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(*os.PathError).Error()
	p.Ret(1, ret0)
}

func execmPathErrorUnwrap(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(*os.PathError).Unwrap()
	p.Ret(1, ret0)
}

func execmPathErrorTimeout(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(*os.PathError).Timeout()
	p.Ret(1, ret0)
}

func execPipe(_ int, p *igo.Context) {
	ret0, ret1, ret2 := os.Pipe()
	p.Ret(0, ret0, ret1, ret2)
}

func execmProcessRelease(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(*os.Process).Release()
	p.Ret(1, ret0)
}

func execmProcessKill(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(*os.Process).Kill()
	p.Ret(1, ret0)
}

func execmProcessWait(_ int, p *igo.Context) {
	args := p.GetArgs(1)
...
func execmProcessSignal(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := args[0].(*os.Process).Signal(toType1(args[1]))
	p.Ret(2, ret0)
}

func execmProcessStateUserTime(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(*os.ProcessState).UserTime()
	p.Ret(1, ret0)
}

func execmProcessStateSystemTime(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(*os.ProcessState).SystemTime()
	p.Ret(1, ret0)
}

func execmProcessStateExited(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(*os.ProcessState).Exited()
	p.Ret(1, ret0)
}

func execmProcessStateSuccess(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(*os.ProcessState).Success()
	p.Ret(1, ret0)
}

func execmProcessStateSys(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(*os.ProcessState).Sys()
	p.Ret(1, ret0)
}

func execmProcessStateSysUsage(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(*os.ProcessState).SysUsage()
	p.Ret(1, ret0)
}

func execmProcessStatePid(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(*os.ProcessState).Pid()
	p.Ret(1, ret0)
}

func execmProcessStateString(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(*os.ProcessState).String()
	p.Ret(1, ret0)
}

func execmProcessStateExitCode(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(*os.ProcessState).ExitCode()
	p.Ret(1, ret0)
}

func execReadlink(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0, ret1 := os.Readlink(args[0].(string))
	p.Ret(1, ret0, ret1)
}

func execRemove(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := os.Remove(args[0].(string))
	p.Ret(1, ret0)
}

func execRemoveAll(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := os.RemoveAll(args[0].(string))
	p.Ret(1, ret0)
}

func execRename(_ int, p *igo.Context) {
	args := p.GetArgs(2)
...
func execSameFile(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := os.SameFile(toType2(args[0]), toType2(args[1]))
	p.Ret(2, ret0)
}

func execSetenv(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := os.Setenv(args[0].(string), args[1].(string))
	p.Ret(2, ret0)
}

func execStartProcess(_ int, p *igo.Context) {
	args := p.GetArgs(3)
	ret0, ret1 := os.StartProcess(args[0].(string), args[1].([]string), args[2].(*os.ProcAttr))
	p.Ret(3, ret0, ret1)
}

func execStat(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0, ret1 := os.Stat(args[0].(string))
	p.Ret(1, ret0, ret1)
}

func execSymlink(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := os.Symlink(args[0].(string), args[1].(string))
	p.Ret(2, ret0)
}

func execmSyscallErrorError(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(*os.SyscallError).Error()
	p.Ret(1, ret0)
}

func execmSyscallErrorUnwrap(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(*os.SyscallError).Unwrap()
	p.Ret(1, ret0)
}

func execmSyscallErrorTimeout(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(*os.SyscallError).Timeout()
	p.Ret(1, ret0)
}

func execTempDir(_ int, p *igo.Context) {
	ret0 := os.TempDir()
	p.Ret(0, ret0)
}

func execTruncate(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := os.Truncate(args[0].(string), args[1].(int64))
	p.Ret(2, ret0)
}

func execUnsetenv(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := os.Unsetenv(args[0].(string))
	p.Ret(1, ret0)
}

func execUserCacheDir(_ int, p *igo.Context) {
	ret0, ret1 := os.UserCacheDir()
	p.Ret(0, ret0, ret1)
}

func execUserConfigDir(_ int, p *igo.Context) {
	ret0, ret1 := os.UserConfigDir()
	p.Ret(0, ret0, ret1)
}

func execUserHomeDir(_ int, p *igo.Context) {
	ret0, ret1 := os.UserHomeDir()
	p.Ret(0, ret0, ret1)
}

// I is a Go package instance.
var I = igo.NewGoPackage("os")
