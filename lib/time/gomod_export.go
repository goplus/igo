...
func execAfter(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := time.After(args[0].(time.Duration))
	p.Ret(1, ret0)
}

func execAfterFunc(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := time.AfterFunc(args[0].(time.Duration), args[1].(func()))
	p.Ret(2, ret0)
}

func execDate(_ int, p *igo.Context) {
	args := p.GetArgs(8)
	ret0 := time.Date(args[0].(int), args[1].(time.Month), args[2].(int), args[3].(int), args[4].(int), args[5].(int), args[6].(int), args[7].(*time.Location))
	p.Ret(8, ret0)
}

func execmDurationString(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(time.Duration).String()
	p.Ret(1, ret0)
}

func execmDurationNanoseconds(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(time.Duration).Nanoseconds()
	p.Ret(1, ret0)
}

func execmDurationMicroseconds(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(time.Duration).Microseconds()
	p.Ret(1, ret0)
}

func execmDurationMilliseconds(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(time.Duration).Milliseconds()
	p.Ret(1, ret0)
}

func execmDurationSeconds(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(time.Duration).Seconds()
	p.Ret(1, ret0)
}

func execmDurationMinutes(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(time.Duration).Minutes()
	p.Ret(1, ret0)
}

func execmDurationHours(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(time.Duration).Hours()
	p.Ret(1, ret0)
}

func execmDurationTruncate(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := args[0].(time.Duration).Truncate(args[1].(time.Duration))
	p.Ret(2, ret0)
}

func execmDurationRound(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := args[0].(time.Duration).Round(args[1].(time.Duration))
	p.Ret(2, ret0)
}

func execFixedZone(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := time.FixedZone(args[0].(string), args[1].(int))
	p.Ret(2, ret0)
}

func execLoadLocation(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0, ret1 := time.LoadLocation(args[0].(string))
	p.Ret(1, ret0, ret1)
}

func execLoadLocationFromTZData(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0, ret1 := time.LoadLocationFromTZData(args[0].(string), args[1].([]byte))
	p.Ret(2, ret0, ret1)
}

func execmLocationString(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(*time.Location).String()
	p.Ret(1, ret0)
}

func execmMonthString(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(time.Month).String()
	p.Ret(1, ret0)
}

func execNewTicker(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := time.NewTicker(args[0].(time.Duration))
	p.Ret(1, ret0)
}

func execNewTimer(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := time.NewTimer(args[0].(time.Duration))
	p.Ret(1, ret0)
}

func execNow(_ int, p *igo.Context) {
	ret0 := time.Now()
	p.Ret(0, ret0)
}

func execParse(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0, ret1 := time.Parse(args[0].(string), args[1].(string))
	p.Ret(2, ret0, ret1)
}

func execParseDuration(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0, ret1 := time.ParseDuration(args[0].(string))
	p.Ret(1, ret0, ret1)
}

func execmParseErrorError(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(*time.ParseError).Error()
	p.Ret(1, ret0)
}

func execParseInLocation(_ int, p *igo.Context) {
	args := p.GetArgs(3)
	ret0, ret1 := time.ParseInLocation(args[0].(string), args[1].(string), args[2].(*time.Location))
	p.Ret(3, ret0, ret1)
}

func execSince(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := time.Since(args[0].(time.Time))
	p.Ret(1, ret0)
}

func execSleep(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	time.Sleep(args[0].(time.Duration))
	p.PopN(1)
}

func execTick(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := time.Tick(args[0].(time.Duration))
	p.Ret(1, ret0)
}

func execmTickerStop(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	args[0].(*time.Ticker).Stop()
	p.PopN(1)
}

func execmTimeString(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(time.Time).String()
	p.Ret(1, ret0)
}

func execmTimeFormat(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := args[0].(time.Time).Format(args[1].(string))
	p.Ret(2, ret0)
}

func execmTimeAppendFormat(_ int, p *igo.Context) {
	args := p.GetArgs(3)
	ret0 := args[0].(time.Time).AppendFormat(args[1].([]byte), args[2].(string))
	p.Ret(3, ret0)
}

func execmTimeAfter(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := args[0].(time.Time).After(args[1].(time.Time))
	p.Ret(2, ret0)
}

func execmTimeBefore(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := args[0].(time.Time).Before(args[1].(time.Time))
	p.Ret(2, ret0)
}

func execmTimeEqual(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := args[0].(time.Time).Equal(args[1].(time.Time))
	p.Ret(2, ret0)
}

func execmTimeIsZero(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(time.Time).IsZero()
	p.Ret(1, ret0)
}

func execmTimeDate(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0, ret1, ret2 := args[0].(time.Time).Date()
	p.Ret(1, ret0, ret1, ret2)
}

func execmTimeYear(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(time.Time).Year()
	p.Ret(1, ret0)
}

func execmTimeMonth(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(time.Time).Month()
	p.Ret(1, ret0)
}

func execmTimeDay(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(time.Time).Day()
	p.Ret(1, ret0)
}

func execmTimeWeekday(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(time.Time).Weekday()
	p.Ret(1, ret0)
}

func execmTimeISOWeek(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0, ret1 := args[0].(time.Time).ISOWeek()
	p.Ret(1, ret0, ret1)
}

func execmTimeClock(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0, ret1, ret2 := args[0].(time.Time).Clock()
	p.Ret(1, ret0, ret1, ret2)
}

func execmTimeHour(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(time.Time).Hour()
	p.Ret(1, ret0)
}

func execmTimeMinute(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(time.Time).Minute()
	p.Ret(1, ret0)
}

func execmTimeSecond(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(time.Time).Second()
	p.Ret(1, ret0)
}

func execmTimeNanosecond(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(time.Time).Nanosecond()
	p.Ret(1, ret0)
}

func execmTimeYearDay(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(time.Time).YearDay()
	p.Ret(1, ret0)
}

func execmTimeAdd(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := args[0].(time.Time).Add(args[1].(time.Duration))
	p.Ret(2, ret0)
}

func execmTimeSub(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := args[0].(time.Time).Sub(args[1].(time.Time))
	p.Ret(2, ret0)
}

func execmTimeAddDate(_ int, p *igo.Context) {
	args := p.GetArgs(4)
	ret0 := args[0].(time.Time).AddDate(args[1].(int), args[2].(int), args[3].(int))
	p.Ret(4, ret0)
}

func execmTimeUTC(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(time.Time).UTC()
	p.Ret(1, ret0)
}

func execmTimeLocal(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(time.Time).Local()
	p.Ret(1, ret0)
}

func execmTimeIn(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := args[0].(time.Time).In(args[1].(*time.Location))
	p.Ret(2, ret0)
}

func execmTimeLocation(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(time.Time).Location()
	p.Ret(1, ret0)
}

func execmTimeZone(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0, ret1 := args[0].(time.Time).Zone()
	p.Ret(1, ret0, ret1)
}

func execmTimeUnix(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(time.Time).Unix()
	p.Ret(1, ret0)
}

func execmTimeUnixNano(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(time.Time).UnixNano()
	p.Ret(1, ret0)
}

func execmTimeMarshalBinary(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0, ret1 := args[0].(time.Time).MarshalBinary()
	p.Ret(1, ret0, ret1)
}

func execmTimeUnmarshalBinary(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := args[0].(*time.Time).UnmarshalBinary(args[1].([]byte))
	p.Ret(2, ret0)
}

func execmTimeGobEncode(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0, ret1 := args[0].(time.Time).GobEncode()
	p.Ret(1, ret0, ret1)
}

func execmTimeGobDecode(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := args[0].(*time.Time).GobDecode(args[1].([]byte))
	p.Ret(2, ret0)
}

func execmTimeMarshalJSON(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0, ret1 := args[0].(time.Time).MarshalJSON()
	p.Ret(1, ret0, ret1)
}

func execmTimeUnmarshalJSON(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := args[0].(*time.Time).UnmarshalJSON(args[1].([]byte))
	p.Ret(2, ret0)
}

func execmTimeMarshalText(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0, ret1 := args[0].(time.Time).MarshalText()
	p.Ret(1, ret0, ret1)
}

func execmTimeUnmarshalText(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := args[0].(*time.Time).UnmarshalText(args[1].([]byte))
	p.Ret(2, ret0)
}

func execmTimeTruncate(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := args[0].(time.Time).Truncate(args[1].(time.Duration))
	p.Ret(2, ret0)
}

func execmTimeRound(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := args[0].(time.Time).Round(args[1].(time.Duration))
	p.Ret(2, ret0)
}

func execmTimerStop(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(*time.Timer).Stop()
	p.Ret(1, ret0)
}

func execmTimerReset(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := args[0].(*time.Timer).Reset(args[1].(time.Duration))
	p.Ret(2, ret0)
}

func execUnix(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := time.Unix(args[0].(int64), args[1].(int64))
	p.Ret(2, ret0)
}

func execUntil(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := time.Until(args[0].(time.Time))
	p.Ret(1, ret0)
}

func execmWeekdayString(_ int, p *igo.Context) {
	args := p.GetArgs(1)
