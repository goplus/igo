...
func execmFloat64SliceSearch(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := args[0].(sort.Float64Slice).Search(args[1].(float64))
	p.Ret(2, ret0)
}

func execmFloat64SliceLen(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(sort.Float64Slice).Len()
	p.Ret(1, ret0)
}

func execmFloat64SliceLess(_ int, p *igo.Context) {
	args := p.GetArgs(3)
	ret0 := args[0].(sort.Float64Slice).Less(args[1].(int), args[2].(int))
	p.Ret(3, ret0)
}

func execmFloat64SliceSwap(_ int, p *igo.Context) {
	args := p.GetArgs(3)
	args[0].(sort.Float64Slice).Swap(args[1].(int), args[2].(int))
	p.PopN(3)
}

func execmFloat64SliceSort(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	args[0].(sort.Float64Slice).Sort()
	p.PopN(1)
}

func execFloat64s(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	sort.Float64s(args[0].([]float64))
	p.PopN(1)
}

func execFloat64sAreSorted(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := sort.Float64sAreSorted(args[0].([]float64))
	p.Ret(1, ret0)
}

func execmIntSliceSearch(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := args[0].(sort.IntSlice).Search(args[1].(int))
	p.Ret(2, ret0)
}

func execmIntSliceLen(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(sort.IntSlice).Len()
	p.Ret(1, ret0)
}

func execmIntSliceLess(_ int, p *igo.Context) {
	args := p.GetArgs(3)
	ret0 := args[0].(sort.IntSlice).Less(args[1].(int), args[2].(int))
	p.Ret(3, ret0)
}

func execmIntSliceSwap(_ int, p *igo.Context) {
	args := p.GetArgs(3)
	args[0].(sort.IntSlice).Swap(args[1].(int), args[2].(int))
	p.PopN(3)
}

func execmIntSliceSort(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	args[0].(sort.IntSlice).Sort()
	p.PopN(1)
}

func execInts(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	sort.Ints(args[0].([]int))
	p.PopN(1)
}

func execIntsAreSorted(_ int, p *igo.Context) {
	args := p.GetArgs(1)
...
func execIsSorted(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := sort.IsSorted(toType0(args[0]))
	p.Ret(1, ret0)
}

func execReverse(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := sort.Reverse(toType0(args[0]))
	p.Ret(1, ret0)
}

func execSearch(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := sort.Search(args[0].(int), args[1].(func(int) bool))
	p.Ret(2, ret0)
}

func execSearchFloat64s(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := sort.SearchFloat64s(args[0].([]float64), args[1].(float64))
	p.Ret(2, ret0)
}

func execSearchInts(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := sort.SearchInts(args[0].([]int), args[1].(int))
	p.Ret(2, ret0)
}

func execSearchStrings(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := sort.SearchStrings(args[0].([]string), args[1].(string))
	p.Ret(2, ret0)
}

func execSlice(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	sort.Slice(args[0], args[1].(func(i int, j int) bool))
	p.PopN(2)
}

func execSliceIsSorted(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := sort.SliceIsSorted(args[0], args[1].(func(i int, j int) bool))
	p.Ret(2, ret0)
}

func execSliceStable(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	sort.SliceStable(args[0], args[1].(func(i int, j int) bool))
	p.PopN(2)
}

func execSort(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	sort.Sort(toType0(args[0]))
	p.PopN(1)
}

func execStable(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	sort.Stable(toType0(args[0]))
	p.PopN(1)
}

func execmStringSliceSearch(_ int, p *igo.Context) {
	args := p.GetArgs(2)
	ret0 := args[0].(sort.StringSlice).Search(args[1].(string))
	p.Ret(2, ret0)
}

func execmStringSliceLen(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	ret0 := args[0].(sort.StringSlice).Len()
	p.Ret(1, ret0)
}

func execmStringSliceLess(_ int, p *igo.Context) {
	args := p.GetArgs(3)
	ret0 := args[0].(sort.StringSlice).Less(args[1].(int), args[2].(int))
	p.Ret(3, ret0)
}

func execmStringSliceSwap(_ int, p *igo.Context) {
	args := p.GetArgs(3)
	args[0].(sort.StringSlice).Swap(args[1].(int), args[2].(int))
	p.PopN(3)
}

func execmStringSliceSort(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	args[0].(sort.StringSlice).Sort()
	p.PopN(1)
}

func execStrings(_ int, p *igo.Context) {
	args := p.GetArgs(1)
	sort.Strings(args[0].([]string))
	p.PopN(1)
}

func execStringsAreSorted(_ int, p *igo.Context) {
	args := p.GetArgs(1)
