...
// Package base defines shared basic pieces of the igo command,
...
// A Command is an implementation of a igo command
// like igo export or igo install.
type Command struct {
...
func (c *Command) LongName() string {
	...
	return strings.TrimPrefix(name, "igo ")
}
